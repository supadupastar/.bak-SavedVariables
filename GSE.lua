...
GSELibrary = {
	{
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence [combat] Thunder Clap, Shield Block, Spell Reflection", -- [5]
					"/castsequence [combat] Shockwave", -- [6]
					"/castsequence Impending Victory", -- [7]
					"/castsequence Devastate", -- [8]
					"/castsequence Shield Slam", -- [9]
					"/castsequence Revenge", -- [10]
					["PostMacro"] = {
						"/startattack", -- [1]
					},
					["Head"] = false,
		...
		["SAM_Fury1"] = {
			...
			["MacroVersions"] = {
				...
				}, -- [1]
				{
					...
					["KeyRelease"] = {
						"/startattack", -- [1]
						"/cast [combat] Odyn's Fury", -- [2]
					},
					["KeyPress"] = {
						"/targetenemy [noharm][dead]", -- [1]
						"/startattack", -- [2]
						"/cast [combat] Battle Cry", -- [3]
						"/cast [combat] Berserker Rage", -- [4]
		...
		["SAM_Arms_ST"] = {
			...
			["MacroVersions"] = {
				{
					"/cast Execute", -- [1]
					"/cast Colossus Smash", -- [2]
					"/cast Mortal Strike", -- [3]
					"/cast Rend", -- [4]
					"/cast Slam", -- [5]
					"/cast Victory Rush", -- [6]
					["KeyRelease"] = {
		...
		["HP_BladeFury"] = {
			...
			["MacroVersions"] = {
				{
					"/cast Bloodthirst", -- [1]
					"/cast Furious Slash", -- [2]
					"/cast Raging Blow", -- [3]
					"/cast Rampage", -- [4]
					"/cast Execute", -- [5]
					"/cast [combat] Odyn's Fury", -- [6]
					"/cast [combat] dragon roar", -- [7]
					["PostMacro"] = {
					},
					["Head"] = false,
					["Neck"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/cast Consecration", -- [3]
					"/cast Holy Shock", -- [4]
					"/cast !Divine Protection", -- [5]
					["PostMacro"] = {
						"/cast [combat] Aura Master", -- [1]
					},
					["Head"] = false,
					["Neck"] = false,
					["Belt"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/cast Eye for an Eye", -- [2]
					"/cast Blessing of Protection", -- [3]
					"/cast Shield of Vengeance", -- [4]
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence Slice and Dic, Saber Slash, Saber Slash, Saber Slash, Saber Slash, Pistol Shot, Run Through, Saber Slash, Saber Slash, Saber Slash, Saber Slash, Pistol Shot", -- [2]
					"/cast Gouge", -- [3]
					"/cast Crimson Vial", -- [4]
				...
				}, -- [1]
				{
					...
					"/castsequence Saber Slash, Run Through, Saber Slash, Pistol Shot", -- [2]
					"/castsequence [talent:7/1] Slice and Dice; [talent:7/2][talent:7/3] Roll the Bones, Saber Slash, Saber Slash, Saber Slash, Saber Slash, Pistol Shot, Run Through, Saber Slash, Saber Slash, Saber Slash, Saber Slash, Pistol Shot", -- [3]
					"/castsequence Ghostly Strike, Saber Slash, Saber Slash, Saber Slash, Saber Slash, Pistol Shot", -- [4]
					"/castsequence [mod:alt] Blade Flurry", -- [5]
					"/cast Crimson Vial", -- [6]
					["PostMacro"] = {
					},
			...
			["MacroVersions"] = {
				{
					...
					"/cast Shadowstrike", -- [2]
					"/cast Shadow Blades", -- [3]
					"/cast Vanish", -- [4]
					"/cast Nightblade", -- [5]
					"/cast Shadow Dance", -- [6]
					"/cast Eviscerate", -- [7]
					"/cast Backstab", -- [8]
					"/cast [combat] Shuriken Storm", -- [9]
					["PostMacro"] = {
					},
					["KeyPress"] = {
						"/targetenemy [noharm][dead]", -- [1]
			...
			["MacroVersions"] = {
				{
					...
					"/cast [combat, nochanneling: Shadow Word: Pain][@player] Power Word: Shield", -- [2]
					"/cast [combat, nochanneling] Dispersion", -- [3]
					"/use Healthstone", -- [4]
					["Trinket1"] = false,
					["Head"] = false,
					["Neck"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/cast [@mouseover,harm,nodead] Plea", -- [2]
					"/cast [combat][nochanneling: Penance] Power Word: Shield", -- [3]
					"/cast [nochanneling: Penance] Power Word: Radiance", -- [4]
					["PostMacro"] = {
					},
					["Head"] = false,
					["Neck"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence [nochanneling: Penance] Power Word: Solace, Purge the Wicked, Divine Star", -- [2]
					"/cast [nochanneling: Penance] Penance", -- [3]
					"/cast [nochanneling: Penance] Smite", -- [4]
					"/cast [combat][nochanneling: Penance] Power Word: Shield", -- [5]
					["PostMacro"] = {
					},
					["Head"] = false,
					["Neck"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/cast [combat][nochanneling: Plea] Pain Suppression", -- [2]
					"/cast [combat][nochanneling: Plea][@player] Power Word: Shield", -- [3]
					"/castsequence [@player] Plea, Plea, Shadow Mend", -- [4]
					"/targetenemy [noharm][dead]", -- [5]
					"/cast [nochanneling: Penance] Light's Wrath", -- [6]
					"/castsequence [@player] Plea, Plea, Shadow Mend", -- [7]
					["PostMacro"] = {
					},
					["Head"] = false,
					["Neck"] = false,
			...
			["MacroVersions"] = {
				{
					...
					"/cast Obliterate", -- [2]
					"/cast Obliteration", -- [3]
					"/castsequence  reset=combat/target/22  Howling Blast, Obliterate", -- [4]
					"/cast Remorseless Winter", -- [5]
					"/cast Death Strike", -- [6]
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
	...
	}, -- [7]
	{
		...
		["FMage"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [no channeling] Fire Blast, Fire Blast, Pyroblast, Fire Blast, Fire Blast, Pyroblast", -- [1]
					"/castsequence [no channeling] Phoenix's Flames, Pyroblast, Phoenix's Flames, Pyroblast", -- [2]
					"/cast combustion", -- [3]
					"/cast [no channeling] Fireball", -- [4]
					"/cast [no channeling] Fireball", -- [5]
					"/cast [no channeling] Fireball", -- [6]
					"/cast [no channeling] Fireball", -- [7]
					"/cast [no channeling] Fireball", -- [8]
					"/castsequence [no channeling] scorch", -- [9]
					["PostMacro"] = {
					},
					["Head"] = false,
					["Neck"] = false,
	...
	}, -- [8]
	{
		...
		["HP_EX_Aff_ST"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nochanneling] reset=combat/reset  Agony, Corruption, Siphon Life, Drain Soul, Drain Soul", -- [1]
					"/cast [nochanneling] Unstable Affliction", -- [2]
					"/castsequence [nochanneling] Unstable Affliction, Drain Soul, Reap Souls, Drain Soul", -- [3]
					"/cast Phantom Singularity", -- [4]
					["PostMacro"] = {
					},
					["Head"] = false,
					["Neck"] = false,
				...
				{
					"/castsequence [nochanneling] reset=combat/reset  Agony, Corruption, Siphon Life, Drain Soul", -- [1]
					"/cast [nochanneling] Unstable Affliction", -- [2]
					"/castsequence [nochanneling] Unstable Affliction, Drain Soul, Reap Souls", -- [3]
					"/castsequence [nochanneling] Phantom Singularity, Mortal Coil", -- [4]
					"/cast Dimensional Rift", -- [5]
					["PostMacro"] = {
					},
					["StepFunction"] = "Sequential",
					["KeyPress"] = {
		...
		["SAM_Destro"] = {
			...
			["MacroVersions"] = {
				{
					"/castsequence [nochanneling] reset=target/10  Conflagrate, Chaos Bolt", -- [1]
					"/castsequence [nochanneling] Incinerate, Immolate, Incinerate, Immolate, ", -- [2]
					"/cast [nochanneling] Dimensional Rift", -- [3]
			...
			["MacroVersions"] = {
				{
					...
					"/castsequence [nochanneling] Unstable Affliction, Drain Soul, Reap Souls", -- [2]
					"/cast [nochanneling] Drain Soul", -- [3]
					["Trinket1"] = false,
					["Head"] = false,
					["Neck"] = false,
					["Belt"] = false,
